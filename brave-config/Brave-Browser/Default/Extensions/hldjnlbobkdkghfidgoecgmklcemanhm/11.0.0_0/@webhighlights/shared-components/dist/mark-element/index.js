      ...
      >
        ...
        <main>
          <webhighlights-mark-media-item
            ...
            .hideFullText=${this.hideFullText}
            .mark=${this.mark}
          ></webhighlights-mark-media-item>
        </main>
        <footer class="footer">
