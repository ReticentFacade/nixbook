(()=>{var t={72334:(t,e,i)=>{"use strict";i.r(e),i.d(e,{default:()=>a});var r=i(36758),n=i.n(r),s=i(40935),o=i.n(s)()(n());o.push([t.id,".wh-loading-skeleton{color:rgba(0,0,0,0);opacity:.8;animation:1.25s linear 0s infinite normal none running loadingBlinking}@keyframes loadingBlinking{0%{background:rgba(140,140,140,.15)}70%{background:rgba(67,79,86,.15)}100%{background:rgba(112,145,169,.15)}}:host{font-family:var(--wh-font-family);display:flex;flex-direction:column;padding:0;font-size:14px;width:100%;height:100%;box-sizing:border-box;overflow:hidden}header{padding:8px}main{overflow:auto;padding-left:8px;padding-right:8px}@media(min-width: 600px){main::-webkit-scrollbar{width:6px}main::-webkit-scrollbar-track{background:var(--wh-bg-front-strong)}main::-webkit-scrollbar-thumb{background:var(--wh-border-front-strong);box-shadow:var(--wh-shadow);border-radius:10px}main::-webkit-scrollbar-thumb:hover{background:var(--wh-border-front-strong)}}.search-entities-container{display:block;margin-top:8px}.loading{display:block;margin-top:16px;--spinner-color: var(--wh-text-light)}.search-entity{display:block;height:-moz-fit-content;height:fit-content}.search-entity.selected{background-color:var(--wh-bg-base-hover-strong)}.search-entity.selected::part(search-entity){background-color:var(--wh-bg-base-hover-strong)}.search-entity:hover:not(.selected){background-color:var(--wh-bg-base-hover)}.search-entity:hover:not(.selected)::part(search-entity){background-color:var(--wh-bg-base-hover)}.search-entity.no-results-info{font-size:16px;color:var(--wh-text-lightest);cursor:text}.search-entity.no-results-info:hover{background:none;background-color:none}.icon{color:var(--wh-text-lighter);fill:var(--wh-text-lighter)}.search-bar{width:100%}.search-bar::part(container){border:none;border-bottom:1px solid var(--wh-border-base);padding:8px 4px;border-radius:0}.search-entity-filter-container{display:flex;gap:4px;margin-top:8px}.search-entity-filter-container .search-entity-filter{display:flex;align-items:center;border:1px solid var(--wh-border-back);color:var(--wh-text-lighter);gap:4px;padding:2px 6px;cursor:pointer;background:var(--wh-bg-base);border-radius:4px;transition:all .1s ease-in-out}.search-entity-filter-container.all-enabled .search-entity-filter:hover{background:var(--wh-primary-600);color:#fff}.search-entity-filter-container.not-all-enabled .search-entity-filter:not(.disabled){background:var(--wh-primary-600);color:#fff}.search-entity-filter-container.not-all-enabled .search-entity-filter.disabled{opacity:.4;border-color:var(--wh-border-base)}.search-entity-filter-container.not-all-enabled .search-entity-filter.disabled:hover{background:var(--wh-primary-600);color:#fff}",""]);const a=o},62093:(t,e,i)=>{"use strict";i.r(e),i.d(e,{default:()=>a});var r=i(36758),n=i.n(r),s=i(40935),o=i.n(s)()(n());o.push([t.id,".wh-loading-skeleton{color:rgba(0,0,0,0);opacity:.8;animation:1.25s linear 0s infinite normal none running loadingBlinking}@keyframes loadingBlinking{0%{background:rgba(140,140,140,.15)}70%{background:rgba(67,79,86,.15)}100%{background:rgba(112,145,169,.15)}}:host{font-family:var(--wh-font-family);display:flex;flex-direction:column;padding:0;font-size:14px;width:100%;height:100%;box-sizing:border-box;overflow:hidden}.search-entity-container{display:flex;align-items:center;-moz-column-gap:8px;column-gap:8px;padding:6px 8px;border-radius:4px;cursor:pointer}@media(min-width: 768px){.search-entity-container{-moz-column-gap:12px;column-gap:12px;padding:8px 10px}}.search-entity-container.selected{background-color:var(--wh-bg-base-hover-strong)}.search-entity-container:hover:not(.selected){background-color:var(--wh-bg-base-hover)}.search-entity-container.no-results-info{font-size:16px;color:var(--wh-text-lightest);cursor:text}.search-entity-container.no-results-info:hover{background:none;background-color:none}.search-type-indicator{display:flex;align-items:center;justify-content:center;border:.5px solid var(--wh-border-base);padding:4px;border-radius:4px}.icon{color:var(--wh-text-lighter);fill:var(--wh-text-lighter)}.search-entity-content{display:flex;align-items:center;flex:1 auto;row-gap:4px;line-height:1.18}.entity-info-right{margin-left:auto}.highlights-notes-info::part(badge){font-size:9px;background-color:var(--wh-bg-base)}.search-entity-date{font-size:10px;color:var(--wh-text-lighter);text-align:right;min-width:-moz-max-content;min-width:max-content;margin-left:8px}.entity-details{width:100%;margin-top:4px}.entity-url{font-size:9.5px;color:var(--wh-text-lightest);display:flex;align-items:center;gap:4px}.favicon::part(image){border:none !important}.favicon::part(image){padding:0}.notes-editor::part(notes-container){height:20px;border-radius:0;overflow:hidden;background:rgba(0,0,0,0);border:none;color:var(--wh-text-light);cursor:pointer}.notes-editor::part(notes-container)[focus-within]{color:var(--wh-text);border:none}.notes-editor::part(notes-container):focus-within{color:var(--wh-text);border:none}.notes-editor::part(notes-container){padding:0}.notes-editor::part(text-container){margin:2px 0}",""]);const a=o},40935:t=>{"use strict";t.exports=function(t){var e=[];return e.toString=function(){return this.map((function(e){var i="",r=void 0!==e[5];return e[4]&&(i+="@supports (".concat(e[4],") {")),e[2]&&(i+="@media ".concat(e[2]," {")),r&&(i+="@layer".concat(e[5].length>0?" ".concat(e[5]):""," {")),i+=t(e),r&&(i+="}"),e[2]&&(i+="}"),e[4]&&(i+="}"),i})).join("")},e.i=function(t,i,r,n,s){"string"==typeof t&&(t=[[null,t,void 0]]);var o={};if(r)for(var a=0;a<this.length;a++){var h=this[a][0];null!=h&&(o[h]=!0)}for(var c=0;c<t.length;c++){var l=[].concat(t[c]);r&&o[l[0]]||(void 0!==s&&(void 0===l[5]||(l[1]="@layer".concat(l[5].length>0?" ".concat(l[5]):""," {").concat(l[1],"}")),l[5]=s),i&&(l[2]?(l[1]="@media ".concat(l[2]," {").concat(l[1],"}"),l[2]=i):l[2]=i),n&&(l[4]?(l[1]="@supports (".concat(l[4],") {").concat(l[1],"}"),l[4]=n):l[4]="".concat(n)),e.push(l))}},e}},36758:t=>{"use strict";t.exports=function(t){return t[1]}},32921:(t,e,i)=>{var r=i(72334);r&&r.__esModule&&(r=r.default),t.exports="string"==typeof r?r:r.toString()},16094:(t,e,i)=>{var r=i(62093);r&&r.__esModule&&(r=r.default),t.exports="string"==typeof r?r:r.toString()},28230:(t,e,i)=>{"use strict";i.d(e,{r:()=>o});var r=i(38085),n=i(93811);const s="15",o={[r.MARK_MEDIA_TYPE.PARAGRAPH]:n.html`<svg
    ...
    `,[r.MARK_MEDIA_TYPE.IMAGE]:n.html`
      <webhighlights-icon
        ...
        size=${s}
      ></webhighlights-icon>
    `};r.MARK_MEDIA_TYPE.PARAGRAPH,o[r.MARK_MEDIA_TYPE.PARAGRAPH],r.MARK_MEDIA_TYPE.BLOCKQUOTE,o[r.MARK_MEDIA_TYPE.BLOCKQUOTE],r.MARK_MEDIA_TYPE.HEADING_1,o[r.MARK_MEDIA_TYPE.HEADING_1],r.MARK_MEDIA_TYPE.HEADING_2,o[r.MARK_MEDIA_TYPE.HEADING_2],r.MARK_MEDIA_TYPE.HEADING_3,o[r.MARK_MEDIA_TYPE.HEADING_3],r.MARK_MEDIA_TYPE.BULLET_LIST_ITEM,o[r.MARK_MEDIA_TYPE.BULLET_LIST_ITEM],r.MARK_MEDIA_TYPE.CODE,o[r.MARK_MEDIA_TYPE.CODE]},72593:(t,e,i)=>{"use strict";var r=i(38085),n=i(93811),s=i(95665),o=i(30827),a=i(28230),h=i(16094),c=i.n(h),l=function(t,e,i,r){var n,s=arguments.length,o=s<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};const d=r.SHARED_COMPONENTS_INTERNAL.SearchEntity,p=d.TAG;class g extends o.y{constructor(){super(...arguments),this.selectedIndex=0,this.components=[r.SHARED_COMPONENTS.Icon.TAG,r.SHARED_COMPONENTS.Favicon.TAG,r.SHARED_COMPONENTS.NotesEditor.TAG,r.SHARED_COMPONENTS.BookmarkPreviewHighlightsNotesInfo.TAG]}onSearchEntitySelected(t){this.dispatchEvent(new CustomEvent("selected",{detail:t}))}render(){var t,e,i,s,o,h;return this.searchEntity?n.html`<div
    ...
    >
      <div
        ...
        data-testid=${d.TEST_IDS.SEARCH_TYPE_INDICATOR(this.searchEntity.searchType)}
      >
        ${(0,r.isBookmark)(this.searchEntity)?n.html`
              <webhighlights-favicon
                ...
                class="favicon"
                size="16"
                alt=${`Icon - ${null!==(o=null===(s=this.searchEntity)||void 0===s?void 0:s.title)&&void 0!==o?o:""}`}
              ></webhighlights-favicon>
            `:(0,r.isMark)(this.searchEntity)&&"marks"===this.searchEntity.searchType?a.r[null!==(h=this.searchEntity.mediaType)&&void 0!==h?h:r.DEFAULT_MEDIA_TYPE]:n.html`
                <webhighlights-icon
      ...
      <div class="search-entity-content">
        <div>
          <span data-testid=${d.TEST_IDS.SEARCH_ENTITY_CONTENT}>
          ...
          ${(0,r.isMark)(this.searchEntity)||(0,r.isBookmark)(this.searchEntity)?n.html`
                <div
                  ...
                  data-testid=${d.TEST_IDS.SEARCH_ENTITY_DETAILS}
                >
                  <div class="entity-url">
                    ${(0,r.truncateString)(this.searchEntity.url,40)}
                  </div>
                </div>
              `:n.html``}
        </div>
        <div class="entity-info-right">
          ${this.searchEntity.createdAt>0?n.html`
                <div
                  ...
                  data-testid=${d.TEST_IDS.SEARCH_ENTITY_DATE}
                >
  ...
  `,l([(0,s.property)()],g.prototype,"searchEntity",void 0),l([(0,s.property)()],g.prototype,"selected",void 0),l([(0,s.state)()],g.prototype,"selectedIndex",void 0),o.y.define(p,g)},30827:(t,e,i)=>{"use strict";i.d(e,{y:()=>s});var r=i(38085),n=i(93811);class s extends n.LitElement{constructor(){super(...arguments),this.components=[]}connectedCallback(){super.connectedCallback(),(0,r.lazyDefine)(this.components)}static define(t,e,i){(0,r.defineWebHighlightsElement)(t,e,i)}}},95665:t=>{"use strict";t.exports=LitDecoratorsExternal},93811:t=>{"use strict";t.exports=LitExternal},38085:t=>{"use strict";t.exports=WebHighlightsSharedLibExternal}},e={};function i(r){var n=e[r];if(void 0!==n)return n.exports;var s=e[r]={id:r,exports:{}};return t[r](s,s.exports,i),s.exports}i.n=t=>{var e=t&&t.__esModule?()=>t.default:()=>t;return i.d(e,{a:e}),e},i.d=(t,e)=>{for(var r in e)i.o(e,r)&&!i.o(t,r)&&Object.defineProperty(t,r,{enumerable:!0,get:e[r]})},i.o=(t,e)=>Object.prototype.hasOwnProperty.call(t,e),i.r=t=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})},(()=>{"use strict";var t=i(38085),e=i(93811),r=i(95665),n=i(30827),s=i(32921),o=i.n(s),a=(i(72593),function(t,e,i,r){var n,s=arguments.length,o=s<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o});const h=t.SHARED_COMPONENTS.Search,c=h.TAG,l="search-scroll-container";class d extends n.y{constructor(){super(...arguments),this.marks=[],this.marksWithNotes=[],this.bookmarks=[],this.tags=[],this.pagination=25,this.selectedIndex=0,this.searchValue="",this.searchEntityTypeEnabledMap={bookmarks:!0,marks:!0,tag:!0,notes:!0},this.loading=!0,this.components=[t.SHARED_COMPONENTS.SearchBar.TAG,t.SHARED_COMPONENTS.Icon.TAG,t.SHARED_COMPONENTS.Loading.TAG]}get searchEntities(){const e=this.searchEntityTypeEnabledMap.bookmarks,i=this.searchEntityTypeEnabledMap.marks,r=this.searchEntityTypeEnabledMap.tag,n=this.searchEntityTypeEnabledMap.notes;return[...[...e?this.bookmarks:[],...i?this.marks:[]].map(t.entityToSearchEntity),...r?this.tags.map(t.tagToSearchEntity):[],...n?this.marksWithNotes.map(t.entityToSearchEntity).map((t=>Object.assign(Object.assign({},t),{searchType:"notes"}))):[]].slice(0,this.pagination)}firstUpdated(t){this.updateData(),this.initListeners()}initListeners(){this.searchScrollContainer&&(this.searchScrollContainer.onscroll=t=>{const e=t.target;e.scrollHeight-e.scrollTop<1.1*e.clientHeight&&(this.pagination=this.pagination+25)})}updateData(){return e=this,i=void 0,n=function*(){var e;this.loading=!0;try{const{marks:i,bookmarks:r,tags:n,marksWithNotes:s}=yield(0,t.useContext)().db.getEntitiesForSearchValue({searchValue:(null===(e=this.searchValue)||void 0===e?void 0:e.length)>2?this.searchValue:""});this.marks=i,this.marksWithNotes=s,this.bookmarks=r,this.tags=n}catch(t){console.error(t),this.marks=[],this.bookmarks=[],this.tags=[]}finally{this.loading=!1,this.selectedIndex=0}},new((r=void 0)||(r=Promise))((function(t,s){function o(t){try{h(n.next(t))}catch(t){s(t)}}function a(t){try{h(n.throw(t))}catch(t){s(t)}}function h(e){var i;e.done?t(e.value):(i=e.value,i instanceof r?i:new r((function(t){t(i)}))).then(o,a)}h((n=n.apply(e,i||[])).next())}));var e,i,r,n}onSearchValueCanged(t){this.updateSearchValue("string"==typeof t.detail?t.detail:"")}onCleared(){this.updateSearchValue("")}updateSearchValue(t){this.searchValue!==t&&(this.searchValue=t,this.loading=!0,this.updateData())}onSearchEntitySelected(t){this.triggerSelectedEvent(t),"function"==typeof this.props.onSearchEntitySelected&&this.props.onSearchEntitySelected(t)}triggerSelectedEvent(e){const i={size:"small",type:"grid"};var r,n;(0,t.isBookmark)(e)?(0,t.onBookmarkSelected)(e,(r=e,Object.assign(Object.assign({bookmark:r},i),{bookmarkSelectionOptions:{openAs:"page"}}))):(0,t.isMark)(e)?(0,t.onMarkSelected)(e,(n=e,Object.assign(Object.assign({mark:n},i),{bookmarkSelectionOptions:{openAs:"page"}}))):(0,t.isTagSearchEntity)(e)&&t.notifications.dispatch("selectedTag",{detail:{tag:e.name}})}get searchBarProps(){return Object.assign({autofocus:!0,showCancelBtn:!0},this.props)}onSearchCancelled(){(0,t.closeDialog)()}getSelectedPreviewElement(){var t;return null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(".search-entity.selected")}scrollToSelectedSearchElement(t){const e=this.getSelectedPreviewElement();e instanceof HTMLElement&&e.scrollIntoView(t)}onArrowDown(){this.selectedIndex<this.searchEntities.length-1&&(this.selectedIndex=this.selectedIndex+1),setTimeout((()=>{this.scrollToSelectedSearchElement({block:"end"})}))}onArrowUp(){this.selectedIndex>0&&(this.selectedIndex=this.selectedIndex-1),setTimeout((()=>{this.scrollToSelectedSearchElement({block:"nearest"})}))}onEnter(){const t=this.searchEntities[this.selectedIndex];t&&this.onSearchEntitySelected(t)}onSpecialKeyPress(t){this[`on${t.detail}`]()}get allTypesAreEnabled(){return t.SEARCH_ENTITY_TYPES.every((t=>this.searchEntityTypeEnabledMap[t]))}toggleSearchEntityType(e){const i=this.allTypesAreEnabled,r=i?{bookmarks:!1,marks:!1,tag:!1,notes:!1}:this.searchEntityTypeEnabledMap;r[e]=i||!this.searchEntityTypeEnabledMap[e],this.searchEntityTypeEnabledMap=Object.assign({},r),t.SEARCH_ENTITY_TYPES.every((t=>!this.searchEntityTypeEnabledMap[t]))&&(this.searchEntityTypeEnabledMap={bookmarks:!0,marks:!0,tag:!0,notes:!0})}onSelected(t){this.onSearchEntitySelected(t.detail)}render(){var i;if(!this.props)throw new Error(`Props missing for '${c}'`);return e.html` <header>
    ...
    ${(0,e.unsafeCSS)(o())}
  `,a([(0,r.property)()],d.prototype,"props",void 0),a([(0,r.state)()],d.prototype,"marks",void 0),a([(0,r.state)()],d.prototype,"marksWithNotes",void 0),a([(0,r.state)()],d.prototype,"bookmarks",void 0),a([(0,r.state)()],d.prototype,"tags",void 0),a([(0,r.state)()],d.prototype,"pagination",void 0),a([(0,r.state)()],d.prototype,"selectedIndex",void 0),a([(0,r.state)()],d.prototype,"searchValue",void 0),a([(0,r.state)()],d.prototype,"searchEntityTypeEnabledMap",void 0),a([(0,r.state)()],d.prototype,"loading",void 0),a([(0,r.query)(`#${l}`)],d.prototype,"searchScrollContainer",void 0),n.y.define(c,d)})()})();